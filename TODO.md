...
- [WIP] @session_014cbVnkaS1VLNPhtYyYP3ke-2026-09-18 `engine.py`: ground the `coherent` certificate in optyx's own contraction of the driven functor image with a coherent state on every drive slot, in CI beside the two-photon and distinguishable groundings
- [WIP] @session_014cbVnkaS1VLNPhtYyYP3ke-2026-09-18 Run the coherent certificate on the same pairs, cells and ticks as the bosonic and distinguishable rows (canonical at `T = 2, 3, 4`, the sanity row, the ladder cell, the 20 seeds); render its columns beside them
- [WIP] @session_014cbVnkaS1VLNPhtYyYP3ke-2026-09-18 README findings: coherent against distinguishable and indistinguishable photons, with the 1-WL bound of the coherent drive written up; tests and lint green
- [ ] Rename the PR and rewrite its description: the construction, the three kinds of light, the results, and a classical GNN reference beyond 1-FWL and within 2-FWL
