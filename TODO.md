...
- [WIP] @Codex-2026-08-05 01:50 Rebase the work on PR26 and replace the loss-only depth with the stationary boson-sampling certificate.
- [ ] Keep the implementation inside existing methods/files and preserve the PR26 API.
- [ ] Test certified lossless and lossy depths, `max_steps`, and `chi` through Optyx diagrams.
- [ ] Run the focused suite, `pflake8 optyx`, and the feasible full-suite verification.
