...
- [WIP] @34e6a827-2026-07-23 14:05 Delete commented-out dead code (qubits.py, core/channel.py, utils/perceval_conversion.py) and fix the phantom `lo` docstring references
- [ ] Default `Box.conjugate` to the box itself and delete the identical per-box bodies; delete `determine_output_dimensions` bodies that duplicate a parent
