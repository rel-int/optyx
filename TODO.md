...
- [x] Add `examples/channel_vs_cqmap.py`, a marimo notebook comparing `optyx.channel` with `discopy.quantum.channel`, ending with a paragraph on which one to prefer and how to unify them
